...
define('_CRPCALENDAR_SORT_COLUMN','Ordina per');
define('_CRPCALENDAR_SORT_ASC','Crescente');
define('_CRPCALENDAR_SORT_DESC','Decrescente');
...
// config
define('_CRPCALENDAR_COMPLETE_DATE_FORMAT', 'Formato data completa (data e ora)');
define('_CRPCALENDAR_COMPLETE_DATE_FORMAT_HINT', 'Per i formati utilizzabili, consultare la documentazione della funzione strftime()');
...
define('_CRPCALENDAR_ONLY_DATE_FORMAT', 'Formato della data');
...
define('_CRPCALENDAR_SUBCATEGORY_LISTING','Mostra anche gli eventi delle sottocategorie quando si visualizza una categoria');
...
define('_CRPCALENDAR_WEEKDAY_START', 'La settimana inizia di');
