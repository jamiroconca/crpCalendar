...
function crpCalendar_locationeventsblock_display($blockinfo)
{
	...
	$render->assign('interval', $vars['limit']);
	$render->assign(pnModGetVar('crpCalendar'));

	$blockinfo['content']= $render->fetch('blocks/crpcalendar_block_events.htm');
...
function crpCalendar_locationeventsblock_modify($blockinfo)
{
	...
	return $render->fetch('blocks/crpcalendar_block_locationevents_modify.htm');
...
function crpCalendar_locationeventsblock_update($blockinfo)
{
	...
	$render->clear_cache('blocks/crpcalendar_block_events.htm');
