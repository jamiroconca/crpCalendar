...
function crpCalendar_searchapi_options($args)
{
	if (SecurityUtil :: checkPermission('crpCalendar::', '::', ACCESS_READ))
	{
		...
		$render->assign('active', (isset ($args['active']) && isset ($args['active']['crpCalendar'])) || (!isset ($args['active'])));
		return $render->fetch('crpcalendar_search_options.htm');
	}
	return '';
