...
class crpCalendar
{
	...
	function manageEvents()
	{
		...
		return $this->ui->adminList($rows, $navigationValues['category'], $navigationValues['mainCat'],
																$navigationValues['modvars'], $navigationValues['active']);
	}
	...
	function listEvents()
	{
		...
		return $this->ui->userList($rows, $navigationValues['category'], $navigationValues['mainCat'],
																$navigationValues['modvars'], $navigationValues['typeList']);
	}
	...
	function listMonthEvents()
	{
		...
		return $this->ui->userMonthList($items, $days, $daysexpanded, $navigationValues['t'],
																		$date, $navigationValues['startDate'], $navigationValues['endDate'],
																		$today, $navigationValues['category'], $navigationValues['mainCat'],
																		$navigationValues['modvars'], $navigationValues['viewForm']);
	}
	...
	function listWeekEvents()
	{
		...
		return $this->ui->userWeekList($items, $days, $daysexpanded, $navigationValues['t'],
																		$date, $navigationValues['startDate'], $navigationValues['endDate'],
																		$today, $navigationValues['category'], $navigationValues['mainCat'],
																		$navigationValues['modvars']);
	}
	...
	function listUserPartecipations()
	{
		...
		return $this->ui->userPartecipations($rows, $navigationValues['uid'], $navigationValues['category'],
																					$navigationValues['mainCat'], $navigationValues['modvars']);
	}
	...
	function listAttendees()
	{
		...
		return $this->ui->attendeesList($rows, $navigationValues['category'], $navigationValues['mainCat'],
																		$navigationValues['modvars']);
	}
