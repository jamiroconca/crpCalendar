...
class crpCalendarDAO
{
	 ...
	 */
	function adminList($startnum= 1, $category= null, $clear= false, $ignoreml= true, $modvars= array (), $mainCat= null, $active= null, $interval= null, $sortOrder= 'DESC', $startDate= null, $endDate= null)
	{
	...
	function countAttendeeItems($category= null, $active= null, $uid= null, $eventid= null)
	{
		...
		elseif ($eventid) 
			return DBUtil :: selectExpandedObjectCount('crpcalendar_attendee', $joinInfo, $where, true);
		else
	 ...
	 * @return int on success
	 */
	function countItems($category= null, $active= null, $uid= null, $eventid= false)
	{
		$pntable= pnDBGetTables();
		$crpcalendarcolumn= $pntable['crpcalendar_column'];
