...
class crpCalendarUI
{
	...
	function userList($rows = array (), $startnum = 1, $category = null, $mainCat = null, $modvars = array (), $typeList = null)
	{
		...
		// Return the output that has been generated by this function
		return $pnRender->fetch('crpcalendar_user_view.htm', $typeList . $category . $startnum, $typeList . $category . $startnum);
	}
	...
	function userYearList($rows = array (), $category = null, $mainCat = null, $modvars = array (), $t = null, $date = null)
	{
		...
		// Return the output that has been generated by this function
		return $pnRender->fetch('crpcalendar_user_view_year.htm', $category . $t, $category . $t);
	}
	...
	function userPartecipations($rows = array (), $uid = null, $category = null, $mainCat = null, $modvars = array ())
	{
		...
		// Return the output that has been generated by this function
		return $pnRender->fetch('crpcalendar_user_view_partecipations.htm', $category . $uid, $category . $uid);
	}
	...
	function attendeesList($rows = array (), $category = null, $mainCat = null, $modvars = array ())
	{
		...
		*/
		// Return the output that has been generated by this function
		return $pnRender->fetch('crpcalendar_user_view_attendees.htm', $category, $category);
	}
	...
	function userMonthList($items = array (), $days = array (), $daysexpanded = array (), $t = null, $date = null, $startDate = null, $endDate = null, $today = null, $category = null, $mainCat = null, $modvars = array (), $viewForm = 'table')
	{
		...
		// Return the output that has been generated by this function
		if ($viewForm == 'list')
			return $pnRender->fetch('crpcalendar_user_view_month.htm', $viewForm . $category . $t, $viewForm . $category . $t);
		else
			return $pnRender->fetch('crpcalendar_user_monthlist.htm', $viewForm . $category . $t, $viewForm . $category . $t);
	}
	...
	function userWeekList($items = array (), $days = array (), $daysexpanded = array (), $t = null, $date = null, $startDate = null, $endDate = null, $today = null, $category = null, $mainCat = null, $modvars = array (), $viewForm = 'table')
	{
		...
		// Return the output that has been generated by this function
		return $pnRender->fetch('crpcalendar_user_weeklist.htm', $viewForm . $category . $t, $viewForm . $category . $t);
	}
	 ...
	 * @return string html code
	 */
	function userDayList($items = array (), $day = null, $t = null, $date = null, $startDate = null, $endDate = null, $today = null, $category = null, $mainCat = null, $modvars = array ())
	{
		// Create output object
		$pnRender = pnRender :: getInstance('crpCalendar');
		...
		// Return the output that has been generated by this function
		return $pnRender->fetch('crpcalendar_user_daylist.htm', $category . $t, $category . $t);
	}
	...
	function userDisplay($eventid = null, $item = array (), $modvars = array ())
	{
		...
		// Return the output that has been generated by this function
		return $pnRender->fetch('crpcalendar_user_display.htm', $eventid, $eventid);
	}
	...
	function userSimpleDisplay($eventid = null, $item = array (), $modvars = array ())
	{
		...
		// Return the output that has been generated by this function
		return $pnRender->fetch('crpcalendar_user_simple_display.htm', $eventid, $eventid);
	}
